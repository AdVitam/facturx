    ...
    module Stages
      module TradeAgreementSupport
        module Parties
          ...
          def seller(parent)
            within_group('BG-4', document.seller, element: 'ram:SellerTradeParty', parent:) do |node, party|
          ...
          def buyer(parent)
            within_group('BG-7', document.buyer, element: 'ram:BuyerTradeParty', parent:) do |node, party|
