...
RSpec.describe EuEinvoice::Composers::Ghostscript do
  subject(:composer) do
    described_class.new(
      embedding: EuEinvoice::France::EMBEDDING,
  ...
  it 'raises when Ghostscript does not create an output' do
    ...
    expect { compose }.to raise_error(EuEinvoice::CompositionError, /non-empty PDF/)
  end
