  ...
  class << self
    ...
    def minimum_document(document)
      EuEinvoice::Document.new(
        ...
        buyer: minimum_buyer(document.buyer), delivery: EuEinvoice::Delivery.new,
    ...
    def minimum_seller(party)
      EuEinvoice::Party.new(
        ...
        address: EuEinvoice::Address.new(country_code: party.address.country_code),
        vat_identifier: party.vat_identifier, tax_identifier: party.tax_identifier
      )
    end

    def minimum_buyer(party)
      EuEinvoice::Party.new(name: party.name, legal_registration: party.legal_registration)
    end
