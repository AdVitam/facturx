...
RSpec.describe EuEinvoice::Schematron::Registry do
  ...
  it 'raises a typed error for an unregistered profile' do
    profile = EuEinvoice::Profile.new(id: :custom, guideline_urn: 'urn:custom', conformance_level: 'CUSTOM')
  ...
  def rule_pack_error
    yield
  rescue EuEinvoice::Schematron::RulePackError => e
    e
  end
end
