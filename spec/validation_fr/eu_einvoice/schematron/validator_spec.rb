...
require 'eu_einvoice/schematron/validator'

RSpec.describe EuEinvoice::Schematron::Validator do
  ...
  let(:issues) do
    [EuEinvoice::Validation::Issue.new(code: :schematron_violation, message: 'Invalid', layer: :schematron)]
  end
  ...
  def execution_error
    yield
  rescue EuEinvoice::Schematron::ExecutionError => e
    e
  end
